...
@section('content')
    ...
    <div class="row" xmlns="http://www.w3.org/1999/html">
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" action="{{route('admin.next-review-employee-post',$employee->id)}}"
            ...
            <!-- END EX@extends('admin-layout.app')
        @section('title', "Add Employee Status")
        @section('content')
            ...
            <div class="row" xmlns="http://www.w3.org/1999/html">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            <i class="icon-settings font-dark"></i>
                            <span class="caption-subject bold uppercase">Add Employee Status</span>
                        </div>
                    </div>
                    @if ($errors->any())
                        <div class="alert alert-danger">
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form method="post" action="{{route('admin.add-status-employee',$employee->id)}}"
                                          enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" value="{{$employee->job_id}}" name="job_id">
                                        <div class="row">
