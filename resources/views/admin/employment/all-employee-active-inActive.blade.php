...
@section('title', "All Employees Active And InActive")
@section('content')
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Employees Active And InActive Table</span>
                    </div>
                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                            ...
                            @foreach($data['allEmployees'] ['allEmployees'] as $employee)
                                <tr class="odd gradeX">
                                    ...
                                    {{--<a href="{{route('admin.change-employee-active',$employee->id)}}" class="btn btn-primary">--}}
                                    {{--<i class="fa fa-user-plus"></i> Active </a>--}}
                                    {{--@else--}}
                                    {{--<a href="{{route('admin.change-employee-active',$employee->id)}}" class="btn btn-danger">--}}
