                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" rows="1" name="title"
                                                          placeholder="Title"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <textarea type="text" rows="1"
                                                          placeholder="HashTags" name="hash_tags"
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control" name="view_access_id">
                                                    <option @if(isset($content->youtube->viewAccess)) value="{{$content->youtube->viewAccess->id}}"
                                                            @else value="" @endif>      @if(isset($content->youtube->viewAccess)) {{$content->youtube->viewAccess->name}}
                                                        @else Select View Access @endif </option>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control" name="license_id">
                                                    <option @if(isset($content->youtube->license)) value="{{$content->youtube->license->id}}"
                                                            @else value="" @endif>      @if(isset($content->youtube->license)) {{$content->youtube->license->name}}
                                                        @else Select License @endif </option>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <textarea type="text" rows="1" class="form-control" name="end_screen"
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea type="text" rows="1" name="web_links"
