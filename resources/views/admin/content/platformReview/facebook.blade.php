            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">For FaceBook</span>
                    </div>
                </div>
                @if ($errors->any())
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly value=" {{$content->topic}}"
                                                       placeholder="topic">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly value=" {{$content->category->name}}"
                                                       placeholder="topic">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="playlist"
                                                       placeholder="Playlist">
                                            </div>
                                            <div class="col-md-4">
                                                <label>View Access</label>
                                                <select class="form-control" name="view" required>
                                                    @foreach( $data['facebook_views'] as $view)
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="file" class="form-control" name="tags"
