...
@section('title', "All New Contents")
@section('content')
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> New Contents Table</span>
                    </div>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{route('admin.add-vendor')}}">
                                        <button id="sample_editable_1_new" class="btn sbold green"> Add New Contents
