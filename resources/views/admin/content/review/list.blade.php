            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Review Table </span>
                    </div>
                </div>
                <div class="portlet-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                            ...
                            <tbody>
                            @foreach( $data['allReview']['allReview'] as $plan)
                                <tr class="odd gradeX">
                                    <td class="center"> {{$plan->content->id}} </td>
                                    <td>
                                        <a href="{{route('admin.all-review-view',$plan->content->id)}}" style="color: black">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right" role="menu">
                                                ...
                                                <li>
                                                    <a href="{{route('admin.all-review-view',$plan->content->id)}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-7">
                            <div class="dataTables_paginate paging_bootstrap_full_number" id="sample_1_paginate">
                                {{$data['allReview']['allReview']->links()}}
                            </div>
                        </div>
                    </div>
                </div>
