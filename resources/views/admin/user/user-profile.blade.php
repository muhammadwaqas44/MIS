                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        <div class="tab-content">
                            <form action="{{route('admin.my-profile-update', $data['user']->id)}}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control placeholder-no-fix" type="text" placeholder="Address"
                                           value="{{ $data['user']->address}}" name="address" required/></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control form-control-line" name="profile_image"
                                           value="{{ $data['user']->profile_image}}" required>
                                </div>
