...
@section('title', "All Technical Interviews")
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Technical Interviews Table </span>
                    </div>
                </div>
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column"
                        ...
                        <tbody>
                        @foreach($data['allTechInterviews']['allTechInterviews'] as $interview)
                            <tr class="odd gradeX">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-7">
                            <div class="dataTables_paginate paging_bootstrap_full_number" id="sample_1_paginate">
                                {{$data['allTechInterviews']['allTechInterviews']->links()}}
                            </div>
                        </div>
                    </div>
                </div>
