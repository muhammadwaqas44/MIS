            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Offer Given Table </span>
                    </div>
                </div>
                <div class="portlet-body">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a href="{{route('admin.export-all-offer-given')}}">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                            ...
                            <tbody>
                            @foreach($data['allOfferGiven']['allOfferGiven'] as $interview)
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center">
                                        <a href="{{route('admin.download-offer-latter',$interview->applicant->id)}}">
                                            <button class="btn btn-xs blue"><i class="icon-paper-clip"></i> Offer Latter
                                            </button>
                                        </a></td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right" role="menu">
                                                <li>
                                                    <a href="{{route('admin.view-offer-status',$interview->id)}}">
                                                ...
                                                <li>
                                                    <a href="{{route('admin.add-offer-status',$interview->applicant->id)}}">
                                            ...
                                            {{--<label style="padding: 2px;"><input--}}
                                            {{--type="file"--}}
                                            {{--style="display: none;"--}}
                                            {{--name="file_attach"--}}
                                            {{--class="form-control pull-right"><i--}}
                                            {{--class="icon-paper-clip"></i></label>--}}
                                            {{--</div>--}}
                                            ...
                                            {{--id="addDetailsInterview_{{$interview->id}}"--}}
                                            {{--tabindex="-1" role="dialog" style="width: auto">--}}
                                            {{--<div class="modal-dialog modal-lg">--}}
                                            {{--<!-- Modal content-->--}}
                                            {{--<div class="portlet light ">--}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-7">
                            <div class="dataTables_paginate paging_bootstrap_full_number" id="sample_1_paginate">
                                {{$data['allOfferGiven']['allOfferGiven']->links()}}
                            </div>
                        </div>
                    </div>
                </div>
