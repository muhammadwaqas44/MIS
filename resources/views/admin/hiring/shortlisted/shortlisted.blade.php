            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Shortlisted Table </span>
                    </div>
                </div>
                <div class="portlet-body">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a href="{{route('admin.export-all-shortlisted')}}">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                            ...
                            <tbody>
                            @foreach($data['allShortlisted']['allShortlisted'] as $interview)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right" role="menu">
                                                <li>
                                                    <a href="{{route('admin.view-shortlisted-status',$interview->id)}}">
                                                ...
                                                <li>
                                                    <a href="{{route('admin.add-shortlisted-status',$interview->applicant->id)}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-7">
                            <div class="dataTables_paginate paging_bootstrap_full_number" id="sample_1_paginate">
                                {{$data['allShortlisted']['allShortlisted']->links()}}
                            </div>
                        </div>
                    </div>
                </div>
