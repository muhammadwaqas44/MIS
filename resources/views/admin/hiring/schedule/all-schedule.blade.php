            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> Interview Schedule Table</span>
                    </div>
                ...
                <div
                    ...
                    @if(Session::has('message') && Session::has('alert'))
                        <div class="alert {{ session('alert') }}" role="alert">
                            {{ session('message') }} <button type="button" class="close" data-dismiss="alert">×</button>
                        </div>
                    @endif
                </div>
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <form action="{{route('admin.update-interview-schedule',$schedule->id)}}"
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <label class="control-label">Conneted Call Status</label>
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <label class="control-label">Not Conneted Call Status</label>
