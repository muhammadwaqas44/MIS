                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a href="{{route('admin.export-all-ini-interviews')}}">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right" role="menu" style="z-index: 2;">
                                                <li>
                                                    <a href="{{route('admin.view-initial-interview-status',$interview->id)}}">
                                                ...
                                                <li>
                                                    <a href="{{route('admin.add-initial-interview-status',$interview->applicant->id)}}">
                                            ...
                                            {{--method="post" class="myformSchedule"--}}
                                            {{--enctype="multipart/form-data">--}}
                                            {{--@csrf--}}
