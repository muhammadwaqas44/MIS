...
class CountriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Country::where('id', '!=', NULL)->delete();


        DB::statement(
            DB::raw("INSERT INTO `states` (`id`, `name`, `country_id`) VALUES (1, 'Andaman and Nicobar Islands', 101),
...
(420, 'Petrik', 20),
(421, 'Vicebsk', 20),(422, 'Antwerpen', 21),
(423, 'Berchem', 21),
(424, 'Brabant', 21),
...
;"));
        ...
        DB::statement(DB::raw("INSERT INTO `countries` (`id`, `code`, `name`, `phonecode`) VALUES
(1, 'AF', 'Afghanistan', 93),
(2, 'AL', 'Albania', 355),
(3, 'DZ', 'Algeria', 213),
